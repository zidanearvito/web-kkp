              ...
              <table class="table text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- <a class="btn btn-success" href="<?= site_url('admin/edit/' . $data['id']) ?>">Edit</a> -->
                            <a class="btn btn-danger" href="<?= site_url('admin/delete/' . $data['id']) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach ?>
                </tbody>
